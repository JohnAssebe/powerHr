...
')
     ...
     */ 
         ...
         * @param array $options
         * @return \LaravelFullCalendar\SimpleEvent 
         * @static 
         */ 
        public static function event($title, $isAllDay, $start, $end, $id = null, $options = [])
        {
                        return \LaravelFullCalendar\Calendar::event($title, $isAllDay, $start, $end, $id, $options);
        }
                    /**
        ...
        {
                        /** @var \LaravelFullCalendar\Calendar $instance */
         ...
         *
         * @param string $id
         * @return \LaravelFullCalendar\Calendar 
         * @static 
         */ 
        public static function setId($id)
        {
...
namespace  { 
            ...
            class Calendar extends \LaravelFullCalendar\Facades\Calendar {}
